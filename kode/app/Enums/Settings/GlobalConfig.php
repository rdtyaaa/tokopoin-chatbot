...
enum GlobalConfig {
    ...
    const OLD_SETTING_KEYS= [
        ...
        'logo'             => 'string',
        'loder_logo'       => 'string',
        'admin_logo_sm'    => 'string',
        'admin_logo_lg'    => 'string',
        'site_logo'        => 'string',
        'address'          => 'string',
        ...
        'cod'              => 'string',
        'seller_mode'      => 'string',
        'system_installed_at'      => 'string',

        's_login_google_info'           => 'json',
        's_login_facebook_info'         => 'json',
        'app_settings'                  => 'json',
        'tawk_to'                       => 'json',
        'invoice_logo'                  => 'json',
        'security_settings'             => 'json',
        'open_ai_setting'               => 'json',
        'otp_configuration'             => 'json',
        'task_config'                   => 'json',

        'refund_time_limit'             => 'int',
        'seller_reg_allow'              => 'int',
        'email_notification'            => 'int',
        'sms_notification'              => 'int',
        'refund'                        => 'int',
        'preloader'                     => 'int',
        'sms_gateway_id'                => 'int',
        'email_gateway_id'              => 'int',
        'guest_checkout'                => 'int',
        'status_expiry'                 => 'int',
