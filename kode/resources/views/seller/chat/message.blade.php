        ...
        <div class="messages">
            @forelse ($messages as $message)
                ...
                @php
                      ...
                      $imgURL        = $message->sender_role == 'customer' ?
                ...
                <div class="message-single {{ $positionClass }} d-flex flex-column">
                    <div class="user-area d-inline-flex @if ($message->sender_role != 'customer')  justify-content-end   @endif  align-items-center gap-3 mb-2">
