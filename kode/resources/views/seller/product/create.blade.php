    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form id="createproduct-form" autocomplete="off" class="needs-validation"
                action="{{ route('seller.product.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-6">
                                        <div>
                                            ...
                                            <input name="name" id="name" type="text" class="form-control"
                                                ...
                                                data-test-id="ProductNameInput" required>
                                    ...
                                    <div class="col-xl-6 col-lg-12">
                                        <div>
                                            ...
                                            <input name="slug" id="slug" type="text" class="form-control"
                                                value="{{ old('slug') }}" placeholder="{{ translate('Enter slug') }}" data-test-id="SlugInput"
                                                required>
                                    ...
                                    <div class="col-lg-6">
                                        <div>
                                            ...
                                            <input step="any" required type="text" class="form-control"
                                                id="price" name="price" value="{{ old('price') }}"
                                                placeholder="{{ translate('Product price') }}" data-test-id="ProductPriceInput">
                                    ...
                                    <div class="col-lg-6">
                                        <div>
                                            ...
                                            <input type="number" class="form-control discount_percentage"
                                                ...
                                                placeholder="{{ translate('Discount Percentage') }}" data-test-id="ProductDiscountInput">
                                    ...
                                    <div class="col-lg-6">
                                        <div>
                                            <label for="minimum_purchase_qty"
                                                class="form-label">{{ translate('Purchase
                                                                                            Quantity (Min)') }}
                                            ...
                                            <input type="number" class="form-control" name="minimum_purchase_qty"
                                                ...
                                                placeholder="{{ translate('Min qty should be 1') }}" data-test-id="ProductMinQtyInput" required>
                                        </div>
                                    </div>

                                    <div class="col-lg-6">
                                        <div>
                                            <label for="maximum_purchase_qty"
                                                class="form-label">{{ translate('Purchase
                                                                                            Quantity (Max)') }}
                                                <span class="text-danger">*</span></label>
                                            <input type="number" class="form-control" name="maximum_purchase_qty"
                                                id="maximum_purchase_qty" value="{{ old('maximum_purchase_qty') }}"
                                                placeholder="{{ translate('Max qty unlimited number') }}" data-test-id="ProductMaxQtyInput" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div>
                                            <label for="club_point" class="form-label">{{ translate('Club point') }} <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" class="form-control" name="point" id="club_point"
                                                value="{{ old('point') ? old('point') : 0 }}"
                                                placeholder="{{ translate('Enter club point') }}" data-test-id="ProductClubPointInput" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea required id="short_description" name="short_description" class="form-control text-editor"
                                            placeholder="Must enter minimum of a 100 characters" rows="3" data-test-id="ProductShortDescriptionInput"> {{ old('short_description') }} </textarea>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea id="mail-composer" class="form-control div_editor1 text-editor" name="description" rows="5"
                                            placeholder="{{ translate('Enter Description') }}" data-test-id="ProductDescriptionInput" required>
                                    {{ old('description') }}
                                    </textarea>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row gy-4">
                                    <div class="col-xl-6">
                                        <div>
                                            <label for="featured_image"
                                                class="form-label">{{ translate('Thumbnail Image') }} <span
                                                    class="text-danger">*</span></label>
                                            <input type="file" name="featured_image" id="featured_image"
                                                class="form-control" data-test-id="ProductImageInput" required>
                                            <div id="emailHelp" class="text-danger">
                                                {{ translate('Image Size Should Be') }}
                                    ...
                                    <div class="col-xl-6">
                                        <div>
                                            <label for="product_gallery_image"
                                                class="form-label">{{ translate('Gallery Image') }} <span
                                                    class="text-danger">*</span></label>
                                            <input type="file" name="gallery_image[]" id="product_gallery_image"
                                                class="form-control" multiple data-test-id="ProductImageGalleryInput" required>
                                            <div class="text-danger">{{ translate('Image Size Should Be') }}
                                                {{ file_path()['product']['gallery']['size'] }}
                                            </div>
                                            <div class="d-flex gallery_img flex-wrap gap-2"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pb-3">
                                <div class="form-group row g-3">
                                    ...
                                    <div class="col-md-9">
                                        <select name="choice_attributes[]" data-test-id="ProductAtrSelect" id="select_attributes" class="form-control"
                                            multiple>
                                ...
                                <div class="attribute_options mb-3" data-test-id="ProductAtrOptionsLabel" id="attribute_options">
                                ...
                                <div>
                                    <div class="row g-3">
                                        @foreach ($taxes as $tax)
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" value="{{ $tax->name }}"
                                                    disabled>
                                            ...
                                            <div class="col-md-4">
                                                <input step="any" name="tax_amount[]" type="number"
                                    ...
                                    <div class="col-12">
                                        <div>
                                            <label for="meta_keyword"
                                                class="form-label">{{ translate('Meta Keywords') }}</label>
                                            <select name="meta_keywords[]" id="meta_keyword"
                                                class="form-control keywords" multiple=multiple></select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div>
                                            ...
                                            <textarea class="form-control" rows="3" name="meta_description" id="meta_description"
                                                placeholder="{{ translate('Enter meta description') }}">{{ old('meta_description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mb-3 text-start">
                            <button type="submit" data-test-id="SubmitButton" class="btn btn-success w-sm waves ripple-light">
                                {{ translate('Submit') }}
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                            ...
                            <div class="card-body">
                                    ...
                                    <select name="category_id" id="category_id" class="form-select w-100" required>
                                        ...
                                        @foreach ($categories as $category)
                                            <option {{ old('category_id') == $category->id ? 'selected' : '' }}
                                                value="{{ $category->id }}" data-subcategory="{{ $category->parent }}">
                                ...
                                <div class="mt-2">
                                    <label for="subcategory_id"
                                        class="form-label">{{ translate('Sub Category') }}</label>
                                    ...
                                    <select name="brand_id" id="brand_id" class="form-select">
                                        ...
                                        @foreach ($brands as $brand)
                                            <option {{ old('brand_id') == $brand->id ? 'selected' : '' }}
                                                value="{{ $brand->id }}">{{ get_translation($brand->name) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <textarea class="form-control" name="warranty_policy" rows="5"
                                    placeholder="{{ translate('Enter warranty policy') }}">{{ old('warranty_policy') }}</textarea>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <label class="form-label" for="weight">
                                            {{ translate('Weight') }}<span class="text-danger">
                                                ({{ translate('In KG') }})</span>
                                        </label>

                                        <input step="any" type="number" class="form-control" id="weight"
                                            name="weight" value="{{ old('weight') ? old('weight') : 0 }}"
                                            placeholder="{{ translate('Product Weight') }}">
                                ...
                                <div class="mb-3">
                                    <label for="shipping_delivery_id"
                                        class="form-label">{{ translate('Shipping Carrier/Delivery') }}
                                    </label>

                                    <select class="form-select select2" multiple name="shipping_delivery_id[]"
                                        id="shipping_delivery_id">
                                        @if ($shippingDeliveries->count() > 1)
                                            <option value="0">{{ translate('All') }}</option>
                                        @endif
                                        @foreach ($shippingDeliveries as $shipping)
                                            <option
                                                {{ collect(old('shipping_delivery_id'))->contains($shipping->id) ? 'selected' : '' }}
                                                value="{{ $shipping->id }}">{{ $shipping->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <label class="form-label" for="shipping_fee">
                                        {{ translate('Flat shipping fees') }} <span class="text-danger">*</span>
                                    </label>

                                    <input step="any" placeholder="{{ translate('Enter shipping fees') }}"
                                        name="shipping_fee" id="shipping_fee" type="number" class="form-control"
                                        value="{{ old('shipping_fee') }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input" name="shipping_fee_multiply"
                                            value="1" id="status-switch">
                                        <label class="form-check-label" for="status-switch">
                                            {{ translate('Shipping fees multiply by product QTY') }}</label>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        $('.discount_percentage').on('keyup', function() {
            ...
            if (discount > 100) {
                ...
                if (discount != 0) {
                    $("#dicountAmount").text(`Discount Price {{ default_currency()->symbol }}` +
                    discounted_price);
                } else {
                    $("#dicountAmount").text('');
                }
        ...
        $('#price').on('keyup', function() {
            ...
            if (price != 0 && discount != 0) {
                ...
                $("#dicountAmount").text(`Discount Price{{ default_currency()->symbol }}` + discounted_price);
            } else {
                $("#dicountAmount").text('');
            }
        });
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    <div class="form-group row mb-2">\
                        ...
                        <div class="col-md-9">\
                            <select class="form-select  attribute_value" data-test-id="ProductAtrOptionsSelect" required name="choice_options_' + i + '[]" multiple>\
                                ' + html + '\
                            </select>\
                        </div>\
                    </div>');
