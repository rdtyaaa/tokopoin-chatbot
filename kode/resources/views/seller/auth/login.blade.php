                            ...
                            <div class="text-center mt-2">
                                <div class="w-50 mx-auto" >
                                    <a href="{{route('seller.dashboard')}}">
                                        <img src="{{show_image(file_path()['site_logo']['path'].'/'.site_settings('site_logo'),file_path()['site_logo']['size'])}}" class="w-100 h-100" alt="form-logo">
                                    </a>
                                </div>
                            </div>
                            <div class="p-3">
                                <form action="{{route('seller.authenticate')}}" id="login-form"  method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="username" required @if(is_demo()) value="demoseller" @endif  class="form-control" id="username" placeholder="Enter username">
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                            <input required @if(is_demo()) value="123123" @endif  type="password" name="password"  class="form-control pe-5 password-input" placeholder="Enter password" id="password-input">
                                    ...
                                    <div class="mt-4">
                                        <button         
                                            ...
                                            @if(site_settings('seller_captcha',App\Enums\StatusEnum::false->status()) ==  App\Enums\StatusEnum::true->status())       
                                                class="g-recaptcha btn btn-success w-100 rounded-10"
                                                data-sitekey="{{site_settings('recaptcha_public_key')}}"
                                                data-callback='onSubmit'
                                                data-action='register'
                                            @else
                                                class="btn btn-success w-100 rounded-10"
                                            @endif 
