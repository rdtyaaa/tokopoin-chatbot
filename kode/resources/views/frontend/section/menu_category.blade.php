...
@php
    $menu_categories = Cache::remember(App\Enums\Settings\CacheKey::MENU_CATEGORY->value,24 * 60,
                                        fn() =>  App\Models\MenuCategory::with(['category','category.product','category.product.review','category.product.stock'])->orderBy('serial')->get());
                ...
                <div class="Container">
                    <div class="section-title">
                        ...
                        <div class="section-title-right">
                                <a href="{{{route('category.product', [$category->category->slug ? $category->category->slug :   make_slug(get_translation($category->category->name)),$category->category_id])}}}" class="view-more-btn">
                                    {{translate('View More')}}
                                </a>
                        </div>
                    </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product-item">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h4 class="product-title"> <a href="{{route('product.details',[$product->slug ? $product->slug : make_slug($product->name),$product->id])}}">{{$product->name}}</a></h4>
