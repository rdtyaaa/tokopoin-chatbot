...
<div class="page-content">
	<div class="container-fluid">
		...
		<div class="card">
            ...
            @php
               ...
               $app_settings  = site_settings('deliveryman_app_settings',null) ? json_decode(site_settings('deliveryman_app_settings',null),true) : [];

            @endphp

			<div class="card-body">
                <form action="{{route('admin.general.deliveryman.setting.update')}}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    @php
      ...
      $required =  'required' ;
      if(site_settings('deliveryman_app_settings',null)){
        $required = '';
      }
