        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
				<div class="card">
					...
					<div class="card-body">
						<div class="p-2">
							<form action="{{route('admin.digital.product.attribute.value.store', $digitalProductAttribute->id)}}" method="POST" enctype="multipart/form-data">
								@csrf
								<div>
									<div class="row">
										...
										@forelse($digitalProductAttributeValues as $digitalProductAttributeValue)
											<tr class="@if($loop->even) table-light @endif">
													...
													<td data-label="{{translate('Name')}}">
														{{($digitalProductAttributeValue->name ?? "N/A")}}
													</td>
													...
													<td data-label="{[translate('Action')}}">
														...
														<div class="hstack justify-content-center gap-3">
															...
															@if($digitalProductAttributeValue->file)
																<a href="{{route('admin.digital.product.attribute.value.download',$digitalProductAttributeValue->id)}}" title="{{translate('Download')}}" data-bs-toggle="tooltip" data-bs-placement="top"  class="link-info fs-18 " data-bs-toggle="modal" data-id="{{$digitalProductAttributeValue->id}}"><i class="las la-download"></i>
																</a>
															@endif
