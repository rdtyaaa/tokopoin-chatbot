...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form   autocomplete="off" class="needs-validation"  action="{{ route('admin.promote.flash.deals.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div>
                <div class="card">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-xl-6">
                                <div>
                                    ...
                                    <input class="form-control" type="datetime-local" name="start_date" value="{{old('start_date')}}" id="startDate">
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6">
                                <div class="border rounded p-2 position-relative">
                                    <div class="position-absolute top-0 start-0 w-100">
                                        <input id="searchProduct" class="form-control border-0 border-bottom" type="search" placeholder="{{translate('Search here')}}">
                                    </div>

                                    <ul class="productUl productUl-sub product-scroll mt-5">


                                    </ul>

                                    <div class="text-center mt-5 mb-4 load-more-section d-none">
                        ...
                        <div class="row g-2 align-items-end">
                            ...
                            <div class="col-lg-1 col-sm-2 col-3">
                                <div class ="d-flex align-items-center justify-content-sm-center justify-content-start">
                                    <button type="button" class="btn btn-sm btn-danger delete-li w-100" data-id= '${id}'><i class="las la-trash"></i></button>
                                </div>
                            </div>
                        </div>
                    </li>
