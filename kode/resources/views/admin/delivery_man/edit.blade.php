...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form action="{{route('admin.delivery-man.update')}}" method="post"  enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-6">
                                    <div>
                                        ...
                                        <input type="text" required class="form-control" id="first_name" value="{{$deliveryman->first_name}}" name="first_name" placeholder="{{translate('Enter first name')}}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div>
                                        ...
                                        <input type="text"  class="form-control" id="last_name" value="{{$deliveryman->last_name}}" name="last_name" placeholder="{{translate('Enter last name')}}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div>
                                        ...
                                        <input type="text" required class="form-control" id="username" value="{{$deliveryman->username}}" name="username" placeholder="{{translate('Enter username')}}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div>
                                        ...
                                        <input type="email" required class="form-control" id="email" value="{{$deliveryman->email}}" name="email" placeholder="{{translate('Enter email')}}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select name="country_id" id="country_id" class="select2 form-control country">
                                        @foreach ($countries as $country )
                                           ...
                                           <option {{$deliveryman->country_id ==  $country->id ? 'selected' :"" }} value="{{  $country->id }}">
                                             {{ $country->name }}
                                           </option>
                                    ...
                                    <div class="select-input-wrapper">
                                        <div class="row g-0">
                                            <div class="col-lg-2 col-sm-3 col-4">
                                                <select name="phone_code" class="select2 form-control country-code">
                                                    @foreach (App\Enums\Settings\GlobalConfig::TELEPHONE_CODES as $code )
                                                       ...
                                                       <option {{$deliveryman->phone_code ==  $code['code'] ? 'selected' :"" }} value="{{ $code['code'] }}">
                                                         {{ $code['name']}}
                                                       </option>
                                            ...
                                            <div class="col-lg-10 col-sm-9 col-8">
                                                <input required class="flex-grow-1 form-control" id="phone" type="text" placeholder="0XXXXXX"  name="phone" value="{{$deliveryman->phone}}">
                                            </div>
                                ...
                                <div class="col-xl-12 col-lg-12">
                                    ...
                                    <div id="image-preview-section">
                                        ...
                                        <img alt='{{$deliveryman->image}}' class="mt-2 rounded  d-block avatar-xl img-thumbnail"
                                        src="{{show_image(file_path()['profile']['delivery_man']['path'].'/'.$deliveryman->image,file_path()['profile']['delivery_man']['size']) }}">
                                ...
                                <div class="col-12">
                                    <div>
                                        ...
                                        <input required id="address"   type="text" name="address" class="form-control" value="{{$deliveryman->address->address}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6">
                                    <div>
                                        ...
                                        <input required id="latitude"   type="text" name="latitude" class="form-control" value="{{$deliveryman->address->latitude}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6">
                                    <div>
                                        ...
                                        <input required  id="longitude" type="text" name="longitude" class="form-control" value="{{$deliveryman->address->longitude}}">
                                    </div>
                                </div>
...
<script>
           ...
           $(document).on('ready',function (){
            ...
            function loadGmap() {
                ...
                var latitude  = parseFloat("{{$deliveryman->address->latitude}}");
                var longitude =  parseFloat("{{$deliveryman->address->longitude}}");
