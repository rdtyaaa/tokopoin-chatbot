        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('admin.item.product.inhouse.index')}}">
                        {{translate('Products')}}
                    </a></li>
							...
							<div class="p-3 bg-body rounded">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class=" d-flex justify-content-between align-items-center flex-wrap gap-2 list-group-item">
                                        ...
                                        <div>
                                            <span class="badge bg-light text-dark">{{(get_translation($product->category->name))}}</span>
                                            @if($product->subCategory)
                                                <span class="badge bg-light text-dark">{{(get_translation($product->subCategory->name))}}</span>
                                            @endif
                                        </div>
                                    </li>
                                    ...
                                    <li class=" d-flex justify-content-between align-items-center flex-wrap gap-2 list-group-item">
                                        ...
                                        <span>{{short_amount($product->price)}} </span>
                                    </li>
                                    <li class=" d-flex justify-content-between align-items-center flex-wrap gap-2 list-group-item">
                                        <span class="fw-semibold">
                                            {{translate('Weight')}}
                                        </span>
                                        <span>{{round($product->weight,site_settings('digit_after_decimal',2))}} {{translate('KG')}}</span>
                                    </li>
						...
						<div class="my-4">
							...
							<div>
								<div class="text-muted border p-3 rounded">
									...
									<p>@php echo ($product->short_description) @endphp</p>
								</div>
